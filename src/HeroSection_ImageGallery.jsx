...
const HeroSection_ImageGallery = ({ className }) => {
  return (
    <div className={`flex flex-row gap-5 p-5 min-w-[1024px] bg-inherit ${className}`}>
      {/* Hero Section */}
      <div className="flex flex-col gap-4 flex-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <img src="https://dashboard.codeparrot.ai/api/image/Z5815TRi7Jes38vO/world.png" alt="World" className="w-5 h-5" />
        </div>
        ...
        <div className="flex gap-2.5 items-center">
          ...
          <button className="flex items-center gap-2.5 bg-none border-none text-[#f15a29] font-urbanist text-sm font-medium cursor-pointer">
            Learn More
            <img src="https://dashboard.codeparrot.ai/api/image/Z5815TRi7Jes38vO/arrow-al.png" alt="Arrow" className="w-6 h-6" />
          </button>
        </div>
      </div>
